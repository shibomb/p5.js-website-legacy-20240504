...
* <br><br><span class="small"><em>この例は、Processingウェブサイトの<a href="https://processing.org/examples/edgedetection.html">Edge Detection example</a>を移植したものです。</em></span>
*/
...
function draw() {
  ...
  // 元の画像の右側にedgeImg（エッジ検出した画像）を描画する
