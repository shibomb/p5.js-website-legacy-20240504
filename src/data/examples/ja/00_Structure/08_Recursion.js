/*
 *@name 再帰
 *@arialabel 灰色の円は、その真ん中を横切って2つの灰色の円を持っています。この2つの灰色の円のそれぞれは、その真ん中にさらに灰色の円を持っており、このパターンは、その中にこれ以上描けなくなるまで続きます。
 *@description 関数が自分自身を呼び出すことを意味する再帰のデモです。
 * 再帰的な関数には終了条件が必要で、
 * それがないと無限ループに陥ってしまいます。drawCircle()関数は、
