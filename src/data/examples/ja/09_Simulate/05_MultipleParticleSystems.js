 ...
 * @description マウスをクリックすると、マウスの位置からパーティクルが噴き出すアニメーションを生成します。<br>それぞれのパーティクルの噴出は、ParticlesとCrazyParticles（Particleのサブクラス）で構成されるパーティクルシステムの1インスタンスです。<br>ここで継承と多態性の使用に注意してください。<br>
